...
class RefreshHeader: RefreshComponent {
    ...
    override func placeSubviews() {
        ...
        y = -(h - ignoredScrollViewContentInsetTop)
    }
    ...
    override func scrollViewContentOffsetDidChange(change: NSDictionary?) {
        ...
        if state == .Refreshing {
            ...
            insetT = insetT > h + scrollViewOriginalInset.top ? h + scrollViewOriginalInset.top : insetT;
        ...
        let pullingPercent = (happenOffsetY - offsetY) / h
        ...
        set {
            ...
            if newValue == .Idle {
                ...
                UIView.animateWithDuration(RefreshFastAnimationDuration,
                    animations: {
                        // 增加滚动区域
                        let top = self.scrollViewOriginalInset.top + self.h
